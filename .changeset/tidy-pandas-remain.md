...
- Each entry carries its category as its bullet icon, with a legend explaining them — generated entries included, via a `Fixed:` prefix on the changeset summary
- No bump badge: the version heading already says which bump it was, and a bump level is not a category
