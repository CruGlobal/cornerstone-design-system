...
import type { CsContentChangeEvent } from '../../events/events.js';
export type { CsContentChangeEvent } from '../../events/events.js';

const tagName = 'cs-random-content';
...
const reactWrapper = createComponent({
  ...
  react: React,
  events: {
    onCsContentChange: 'cs-content-change' as EventName<CsContentChangeEvent>,
  },
  displayName: 'CsRandomContent',
});
