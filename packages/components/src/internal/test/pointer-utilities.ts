...
/**
 * True on WebKit. Every Chromium UA string also contains "Safari", so both Chrome spellings have to be
 * excluded — the previous check only excluded `HeadlessChrome`, which made this true on headed Chromium.
 */
