 ...
 * @internal
 */
export default class CornerstoneElement extends LitElement {
  ...
  constructor() {
    ...
    const Self = this.constructor as typeof CornerstoneElement;
  ...
  attributeChangedCallback(name: string, oldValue: string | null, newValue: string | null) {
    if (!this.#hasRecordedInitialProperties) {
      (this.constructor as typeof CornerstoneElement).elementProperties.forEach(
