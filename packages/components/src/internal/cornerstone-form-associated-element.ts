...
import CornerstoneElement from './cornerstone-element.js';
import { CustomErrorValidator } from './validators/custom-error-validator.js';

export interface Validator<T extends CornerstoneFormAssociatedElement = CornerstoneFormAssociatedElement> {
...
export interface CornerstoneFormControl extends CornerstoneElement {
  // Form attributes
  name: null | string;
  disabled?: boolean;
...
export class CornerstoneFormAssociatedElement
  extends CornerstoneElement
  implements Omit<ElementInternals, 'form' | 'setFormValue'>, CornerstoneFormControl
{
  ...
  protected updateFormValue(value: unknown) {
    // Accounts for the snowflake case on `<cs-select>`
  ...
  get allValidators() {
    const staticValidators = (this.constructor as typeof CornerstoneFormAssociatedElement).validators || [];
