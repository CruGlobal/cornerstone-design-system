...
const translation: Translation = {
  ...
  jumpBackwardX: (count) => {
    if (count === 1) {
      return 'الرجوع صفحة واحدة';
    }
    if (count === 2) {
      return 'الرجوع صفحتين';
    }
    if (count > 2 && count < 11) {
      return `الرجوع ${count} صفحات`;
    }
    return `الرجوع ${count} صفحة`;
  },
  jumpForwardX: (count) => {
    if (count === 1) {
      return 'التقدم صفحة واحدة';
    }
    if (count === 2) {
      return 'التقدم صفحتين';
    }
    if (count > 2 && count < 11) {
      return `التقدم ${count} صفحات`;
    }
  ...
  numCharactersRemaining: (num) => {
    if (num === 0) {
      return '0 أحرف متبقية';
    }
    if (num === 1) {
      return '1 حرف متبقٍ';
    }
    if (num === 2) {
      return '2 حرفان متبقيان';
    }
    if (num > 2 && num < 11) {
      return `${num} أحرف متبقية`;
    }
  ...
  numRowsCopied: (num) => {
    if (num === 0) {
      return 'لم يتم نسخ أي صفوف';
    }
    if (num === 1) {
      return 'تم نسخ صف واحد';
    }
    if (num === 2) {
      return 'تم نسخ صفان';
    }
    if (num > 2 && num < 11) {
      return `تم نسخ ${num} صفوف`;
    }
    return `تم نسخ ${num} صفًا`;
  },
  numRowsSelected: (num) => {
    if (num === 0) {
      return 'لم يتم تحديد أي صفوف';
    }
    if (num === 1) {
      return 'تم تحديد صف واحد';
    }
    if (num === 2) {
      return 'تم تحديد صفان';
    }
    if (num > 2 && num < 11) {
      return `تم تحديد ${num} صفوف`;
    }
  ...
  rangeTooLong: (max) => {
    if (max === 1) {
      return 'اختر نطاقًا لا يتجاوز يومًا واحدًا';
    }
    if (max === 2) {
      return 'اختر نطاقًا لا يتجاوز يومين';
    }
    if (max > 2 && max < 11) {
      return `اختر نطاقًا لا يتجاوز ${max} أيام`;
    }
    return `اختر نطاقًا لا يتجاوز ${max} يومًا`;
  },
  rangeTooShort: (min) => {
    if (min === 1) {
      return 'اختر نطاقًا لا يقل عن يوم واحد';
    }
    if (min === 2) {
      return 'اختر نطاقًا لا يقل عن يومين';
    }
    if (min > 2 && min < 11) {
      return `اختر نطاقًا لا يقل عن ${min} أيام`;
    }
