...
const translation: Translation = {
  ...
  jumpBackwardX: (count) => {
    ...
    if (mod10 === 1 && mod100 !== 11) {
      return `Назад на ${count} страницу`;
    }
    if (mod10 >= 2 && mod10 <= 4 && !(mod100 >= 12 && mod100 <= 14)) {
      return `Назад на ${count} страницы`;
    }
  ...
  jumpForwardX: (count) => {
    ...
    const mod100 = count % 100;
    if (mod10 === 1 && mod100 !== 11) {
      return `Вперёд на ${count} страницу`;
    }
    if (mod10 >= 2 && mod10 <= 4 && !(mod100 >= 12 && mod100 <= 14)) {
      return `Вперёд на ${count} страницы`;
    }
  ...
  numCharactersRemaining: (num) => {
    ...
    const mod100 = num % 100;
    if (mod10 === 1 && mod100 !== 11) {
      return `Остался ${num} символ`;
    }
    if (mod10 >= 2 && mod10 <= 4 && !(mod100 >= 12 && mod100 <= 14)) {
      return `Осталось ${num} символа`;
    }
  ...
  numRowsCopied: (num) => {
    ...
    const mod100 = num % 100;
    if (mod10 === 1 && mod100 !== 11) {
      return `Скопирована ${num} строка`;
    }
    if (mod10 >= 2 && mod10 <= 4 && !(mod100 >= 12 && mod100 <= 14)) {
      return `Скопировано ${num} строки`;
    }
  ...
  numRowsSelected: (num) => {
    ...
    const mod100 = num % 100;
    if (mod10 === 1 && mod100 !== 11) {
      return `Выбрана ${num} строка`;
    }
    if (mod10 >= 2 && mod10 <= 4 && !(mod100 >= 12 && mod100 <= 14)) {
      return `Выбрано ${num} строки`;
    }
  ...
  rangeTooLong: (max) => {
    ...
    if (mod10 === 1 && mod100 !== 11) {
      return `Выберите диапазон не длиннее ${max} дня`;
    }
    if (mod10 >= 2 && mod10 <= 4 && !(mod100 >= 12 && mod100 <= 14)) {
  ...
  rangeTooShort: (min) => {
    ...
    if (mod10 === 1 && mod100 !== 11) {
      return `Выберите диапазон длиной не менее ${min} дня`;
    }
    if (mod10 >= 2 && mod10 <= 4 && !(mod100 >= 12 && mod100 <= 14)) {
