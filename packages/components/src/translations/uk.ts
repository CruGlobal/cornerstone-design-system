...
const translation: Translation = {
  ...
  jumpBackwardX: (count) => {
    ...
    if (mod10 === 1 && mod100 !== 11) {
      return `Назад на ${count} сторінку`;
    }
    if (mod10 >= 2 && mod10 <= 4 && !(mod100 >= 12 && mod100 <= 14)) {
      return `Назад на ${count} сторінки`;
    }
  ...
  jumpForwardX: (count) => {
    ...
    const mod100 = count % 100;
    if (mod10 === 1 && mod100 !== 11) {
      return `Уперед на ${count} сторінку`;
    }
    if (mod10 >= 2 && mod10 <= 4 && !(mod100 >= 12 && mod100 <= 14)) {
      return `Уперед на ${count} сторінки`;
    }
  ...
  numCharactersRemaining: (num) => {
    ...
    const mod100 = num % 100;
    if (mod10 === 1 && mod100 !== 11) {
      return `Залишився ${num} символ`;
    }
    if (mod10 >= 2 && mod10 <= 4 && !(mod100 >= 12 && mod100 <= 14)) {
      return `Залишилося ${num} символи`;
    }
  ...
  numOptionsSelected: (num) => {
    const n = num % 10;
    if (n === 0) {
      return 'не вибрано варіантів';
    }
    if (n === 1) {
      return 'вибрано 1 варіант';
    }
    if (n === 2 || n === 3 || n === 4) {
  ...
  numRowsCopied: (num) => {
    ...
    const mod100 = num % 100;
    if (mod10 === 1 && mod100 !== 11) {
      return `Скопійовано ${num} рядок`;
    }
    if (mod10 >= 2 && mod10 <= 4 && !(mod100 >= 12 && mod100 <= 14)) {
      return `Скопійовано ${num} рядки`;
    }
  ...
  numRowsSelected: (num) => {
    ...
    const mod100 = num % 100;
    if (mod10 === 1 && mod100 !== 11) {
      return `Вибрано ${num} рядок`;
    }
    if (mod10 >= 2 && mod10 <= 4 && !(mod100 >= 12 && mod100 <= 14)) {
      return `Вибрано ${num} рядки`;
    }
  ...
  rangeTooLong: (max) => {
    ...
    if (mod10 === 1 && mod100 !== 11) {
      return `Виберіть діапазон не довший за ${max} день`;
    }
    if (mod10 >= 2 && mod10 <= 4 && !(mod100 >= 12 && mod100 <= 14)) {
      return `Виберіть діапазон не довший за ${max} дні`;
    }
  ...
  rangeTooShort: (min) => {
    ...
    if (mod10 === 1 && mod100 !== 11) {
      return `Виберіть діапазон завдовжки щонайменше ${min} день`;
    }
    if (mod10 >= 2 && mod10 <= 4 && !(mod100 >= 12 && mod100 <= 14)) {
