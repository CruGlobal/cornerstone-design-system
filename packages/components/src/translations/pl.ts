...
const translation: Translation = {
  ...
  jumpForwardX: (count) => {
    ...
    const mod100 = count % 100;
    if (mod10 >= 2 && mod10 <= 4 && !(mod100 >= 12 && mod100 <= 14)) {
      return `Przejdź o ${count} strony do przodu`;
    }
  ...
  numCharactersRemaining: (num) => {
    if (num === 1) {
      return 'Pozostał 1 znak';
    }
    const mod10 = num % 10;
    const mod100 = num % 100;
    if (mod10 >= 2 && mod10 <= 4 && !(mod100 >= 12 && mod100 <= 14)) {
      return `Pozostały ${num} znaki`;
    }
  ...
  numOptionsSelected: (num) => {
    ...
    if (num === 1) {
      return 'Wybrano 1 opcję';
    }
    return `Wybrano ${num} opcje`;
  },
  numRowsCopied: (num) => {
    if (num === 1) {
      return 'Skopiowano 1 wiersz';
    }
    const mod10 = num % 10;
    const mod100 = num % 100;
    if (mod10 >= 2 && mod10 <= 4 && !(mod100 >= 12 && mod100 <= 14)) {
      return `Skopiowano ${num} wiersze`;
    }
    return `Skopiowano ${num} wierszy`;
  },
  numRowsSelected: (num) => {
    if (num === 1) {
      return 'Wybrano 1 wiersz';
    }
    const mod10 = num % 10;
    const mod100 = num % 100;
    if (mod10 >= 2 && mod10 <= 4 && !(mod100 >= 12 && mod100 <= 14)) {
      return `Wybrano ${num} wiersze`;
    }
  ...
  rangeTooLong: (max) => {
    if (max === 1) {
      return 'Wybierz zakres nie dłuższy niż 1 dzień';
    }
    const mod10 = max % 10;
  ...
  rangeTooShort: (min) => {
    if (min === 1) {
      return 'Wybierz zakres o długości co najmniej 1 dnia';
    }
    const mod10 = min % 10;
