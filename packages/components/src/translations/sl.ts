...
const translation: Translation = {
  ...
  jumpBackwardX: (count) => {
    ...
    if (mod100 === 1) {
      return `Pomakni se ${count} stran nazaj`;
    }
    if (mod100 === 2) {
  ...
  jumpForwardX: (count) => {
    const mod100 = count % 100;
    if (mod100 === 1) {
      return `Pomakni se ${count} stran naprej`;
    }
    if (mod100 === 2) {
  ...
  numCharactersRemaining: (num) => {
    const mod100 = num % 100;
    if (mod100 === 1) {
      return `Preostane ${num} znak`;
    }
    if (mod100 === 2) {
      return `Preostaneta ${num} znaka`;
    }
    if (mod100 === 3 || mod100 === 4) {
      return `Preostanejo ${num} znaki`;
    }
  ...
  numRowsCopied: (num) => {
    const mod100 = num % 100;
    if (mod100 === 1) {
      return `${num} kopirana vrstica`;
    }
    if (mod100 === 2) {
      return `${num} kopirani vrstici`;
    }
    if (mod100 === 3 || mod100 === 4) {
      return `${num} kopirane vrstice`;
    }
  ...
  numRowsSelected: (num) => {
    const mod100 = num % 100;
    if (mod100 === 1) {
      return `${num} izbrana vrstica`;
    }
    if (mod100 === 2) {
      return `${num} izbrani vrstici`;
    }
    if (mod100 === 3 || mod100 === 4) {
      return `${num} izbrane vrstice`;
    }
  ...
  rangeTooLong: (max) => {
    ...
    if (mod100 === 1) {
      return `Izberite obdobje, ki ni daljše od ${max} dneva`;
    }
    if (mod100 === 2) {
  ...
  rangeTooShort: (min) => {
    ...
    if (mod100 === 1) {
      return `Izberite obdobje, dolgo vsaj ${min} dan`;
    }
    if (mod100 === 2) {
      return `Izberite obdobje, dolgo vsaj ${min} dneva`;
    }
    if (mod100 === 3 || mod100 === 4) {
