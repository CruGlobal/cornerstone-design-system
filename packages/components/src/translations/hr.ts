...
const translation: Translation = {
  ...
  jumpBackwardX: (count) => {
    ...
    if (mod10 === 1 && mod100 !== 11) {
      return `Skoči ${count} stranicu unatrag`;
    }
    if (mod10 >= 2 && mod10 <= 4 && !(mod100 >= 12 && mod100 <= 14)) {
      return `Skoči ${count} stranice unatrag`;
    }
  ...
  jumpForwardX: (count) => {
    ...
    const mod100 = count % 100;
    if (mod10 === 1 && mod100 !== 11) {
      return `Skoči ${count} stranicu unaprijed`;
    }
    if (mod10 >= 2 && mod10 <= 4 && !(mod100 >= 12 && mod100 <= 14)) {
      return `Skoči ${count} stranice unaprijed`;
    }
  ...
  numCharactersRemaining: (num) => {
    if (num === 1) {
      return '1 preostali znak';
    }
    const mod10 = num % 10;
    const mod100 = num % 100;
    if (mod10 >= 2 && mod10 <= 4 && !(mod100 >= 12 && mod100 <= 14)) {
      return `${num} preostala znaka`;
    }
  ...
  numRowsCopied: (num) => {
    if (num === 1) {
      return '1 redak kopiran';
    }
    const mod10 = num % 10;
    const mod100 = num % 100;
    if (mod10 >= 2 && mod10 <= 4 && !(mod100 >= 12 && mod100 <= 14)) {
      return `${num} retka kopirana`;
    }
    return `${num} redaka kopirano`;
  },
  numRowsSelected: (num) => {
    if (num === 1) {
      return '1 redak odabran';
    }
    const mod10 = num % 10;
    const mod100 = num % 100;
    if (mod10 >= 2 && mod10 <= 4 && !(mod100 >= 12 && mod100 <= 14)) {
      return `${num} retka odabrana`;
    }
  ...
  rangeTooLong: (max) => {
    if (max === 1) {
      return 'Odaberite raspon ne dulji od 1 dana';
    }
    const mod10 = max % 10;
  ...
  rangeTooShort: (min) => {
    if (min === 1) {
      return 'Odaberite raspon dug najmanje 1 dan';
    }
    const mod10 = min % 10;
