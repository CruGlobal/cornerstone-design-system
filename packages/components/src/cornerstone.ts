export { getIconFileName, getIconStyle, getIconWeight } from './components/icon/library.default.js';
export {
...
export { getBasePath, getIconPath, setBasePath, setIconPath } from './utilities/base-path.js';
