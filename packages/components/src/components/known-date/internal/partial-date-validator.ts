import type { Validator } from '../../../internal/cornerstone-form-associated-element.js';
 ...
 * Feb 30). Like `<cs-time-input>`, this surfaces through the native constraint validation flow (the browser
...
export const PartialDateValidator = (): Validator => {
  return {
    checkValidity(element) {
      const host = element as unknown as CsKnownDate;
