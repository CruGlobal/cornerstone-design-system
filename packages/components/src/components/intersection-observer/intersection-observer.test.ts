...
import type CsIntersectionObserver from './intersection-observer.js';

describe('<cs-intersection-observer>', () => {
  for (const fixture of fixtures) {
    describe(`with "${fixture.type}" rendering`, () => {
      describe('properties', () => {
        it('should have default property values', async () => {
          const el = await fixture<CsIntersectionObserver>(html`<cs-intersection-observer></cs-intersection-observer>`);
        ...
        it('should reflect the "once" property to an attribute', async () => {
          const el = await fixture<CsIntersectionObserver>(
            html`<cs-intersection-observer once></cs-intersection-observer>`,
          );
        ...
        it('should reflect the "disabled" property to an attribute', async () => {
          const el = await fixture<CsIntersectionObserver>(
            html`<cs-intersection-observer disabled></cs-intersection-observer>`,
          );
        ...
        it('should accept a root-margin attribute', async () => {
          const el = await fixture<CsIntersectionObserver>(
            html`<cs-intersection-observer root-margin="10px 20px"></cs-intersection-observer>`,
          );
        ...
        it('should accept a threshold attribute', async () => {
          const el = await fixture<CsIntersectionObserver>(
            html`<cs-intersection-observer threshold="0.5"></cs-intersection-observer>`,
          );
        ...
        it('should accept an intersect-class attribute', async () => {
          const el = await fixture<CsIntersectionObserver>(
            html`<cs-intersection-observer intersect-class="visible"></cs-intersection-observer>`,
          );
        ...
        it('should accept a root attribute', async () => {
          const el = await fixture<CsIntersectionObserver>(
            html`<cs-intersection-observer root="my-root"></cs-intersection-observer>`,
          );
      ...
      describe('events', () => {
        it('should emit cs-intersect events for slotted children', async () => {
          const handler = sinon.spy();

          const el = await fixture<CsIntersectionObserver>(html`
            <cs-intersection-observer>
              <div style="width: 100px; height: 100px;">Test</div>
            </cs-intersection-observer>
          `);

          el.addEventListener('cs-intersect', handler);

          // The intersection observer fires asynchronously after setup
          await waitUntil(() => handler.called, 'cs-intersect event should fire');
        ...
        it('should not emit events when disabled', async () => {
          ...
          const el = await fixture<CsIntersectionObserver>(html`
            <cs-intersection-observer disabled>
              <div style="width: 100px; height: 100px;">Test</div>
            </cs-intersection-observer>
          `);
