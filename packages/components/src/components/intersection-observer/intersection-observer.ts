...
import { CsIntersectEvent } from '../../events/intersect.js';
...
export default class CsIntersectionObserver extends CornerstoneElement {
  static css = styles;
...
declare global {
  interface HTMLElementTagNameMap {
    'cs-intersection-observer': CsIntersectionObserver;
  }
}
