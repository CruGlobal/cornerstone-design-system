...
import type CsNumberInput from './number-input.js';

describe('<cs-number-input>', () => {
  runFormControlBaseTests({ tagName: 'cs-number-input', formValue: { dirtyValue: 42 } });

  for (const fixture of fixtures) {
    describe(`with "${fixture.type}" rendering`, () => {
      describe('accessibility', () => {
        it('should pass accessibility tests', async () => {
          const el = await fixture<CsNumberInput>(html` <cs-number-input label="Quantity"></cs-number-input> `);
      ...
      describe('properties', () => {
        it('should have correct default property values', async () => {
          const el = await fixture<CsNumberInput>(html` <cs-number-input></cs-number-input> `);
        ...
        it('should have title if title attribute is set', async () => {
          const el = await fixture<CsNumberInput>(html` <cs-number-input title="Test"></cs-number-input> `);
        ...
        it('should be disabled with the disabled attribute', async () => {
          const el = await fixture<CsNumberInput>(html` <cs-number-input disabled></cs-number-input> `);
          await el.updateComplete;
          const input = el.shadowRoot!.querySelector<HTMLInputElement>('input')!;
      ...
      describe('slots', () => {
        it('should have label with "has-label" class if label has a slotted element', async () => {
          const el = await fixture<CsNumberInput>(html`
            <cs-number-input><span slot="label">Quantity</span></cs-number-input>
          `);
          await el.updateComplete;
      ...
      describe('keyboard navigation', () => {
        it('should increment value when ArrowUp is pressed', async () => {
          const el = await fixture<CsNumberInput>(html` <cs-number-input value="5"></cs-number-input> `);
      ...
      describe('step functionality', () => {
        it('should be valid when the value is within the boundary of a step', async () => {
          const el = await fixture<CsNumberInput>(html` <cs-number-input step=".5" value="1.5"></cs-number-input> `);
          expect(el.checkValidity()).to.be.true;
        });

        it('should be invalid when the value is not within the boundary of a step', async () => {
          const el = await fixture<CsNumberInput>(html` <cs-number-input step=".5" value="1.25"></cs-number-input> `);
        ...
        it('should increment by step when stepUp() is called', async () => {
          const el = await fixture<CsNumberInput>(html` <cs-number-input step="2" value="2"></cs-number-input> `);
        ...
        it('should return an empty string when an invalid value is provided via the value attribute', async () => {
          const el = await fixture<CsNumberInput>(html`
            <cs-number-input value="not-a-valid-number"></cs-number-input>
          `);
          await el.updateComplete;
      ...
      describe('stepper buttons', () => {
        ...
        it('should hide stepper buttons when without-steppers is set', async () => {
          const el = await fixture<CsNumberInput>(html` <cs-number-input without-steppers></cs-number-input> `);
          const incrementButton = el.shadowRoot!.querySelector('[part~="stepper-increment"]');
          const decrementButton = el.shadowRoot!.querySelector('[part~="stepper-decrement"]');
        ...
        it('should not change value when stepper buttons are clicked and input is disabled', async () => {
          const el = await fixture<CsNumberInput>(html` <cs-number-input value="5" disabled></cs-number-input> `);
          const incrementButton = el.shadowRoot!.querySelector<HTMLButtonElement>('[part~="stepper-increment"]')!;
          const decrementButton = el.shadowRoot!.querySelector<HTMLButtonElement>('[part~="stepper-decrement"]')!;
        ...
        it('should not change value when stepper buttons are clicked and input is readonly', async () => {
          const el = await fixture<CsNumberInput>(html` <cs-number-input value="5" readonly></cs-number-input> `);
          const incrementButton = el.shadowRoot!.querySelector<HTMLButtonElement>('[part~="stepper-increment"]')!;
          const decrementButton = el.shadowRoot!.querySelector<HTMLButtonElement>('[part~="stepper-decrement"]')!;
        ...
        it('should disable increment button when value is at max', async () => {
          const el = await fixture<CsNumberInput>(html` <cs-number-input value="10" max="10"></cs-number-input> `);
          const incrementButton = el.shadowRoot!.querySelector<HTMLButtonElement>('[part~="stepper-increment"]')!;
        ...
        it('should disable decrement button when value is at min', async () => {
          const el = await fixture<CsNumberInput>(html` <cs-number-input value="0" min="0"></cs-number-input> `);
          const decrementButton = el.shadowRoot!.querySelector<HTMLButtonElement>('[part~="stepper-decrement"]')!;
      ...
      describe('min and max constraints', () => {
        it('should be invalid when value is below min', async () => {
          const el = await fixture<CsNumberInput>(html` <cs-number-input min="5" value="3"></cs-number-input> `);
        ...
        it('should be invalid when value is above max', async () => {
          const el = await fixture<CsNumberInput>(html` <cs-number-input max="10" value="15"></cs-number-input> `);
        ...
        it('should be valid when value is within min and max', async () => {
          const el = await fixture<CsNumberInput>(html`
            <cs-number-input min="0" max="10" value="5"></cs-number-input>
          `);
          expect(el.checkValidity()).to.be.true;
        });
      });
      ...
      describe('form integration', () => {
        it('should serialize its name and value with FormData', async () => {
          const form = await fixture<HTMLFormElement>(html`
            <form><cs-number-input name="a" value="1"></cs-number-input></form>
          `);
        ...
        it('should submit the form when pressing enter in a form without a submit button', async () => {
          const form = await fixture<HTMLFormElement>(html` <form><cs-number-input></cs-number-input></form> `);
          const input = form.querySelector('cs-number-input')!;
        ...
        it('should be present in form data when using the form attribute and located outside of a <form>', async () => {
          const el = await fixture<HTMLFormElement>(html`
            <div>
              ...
              <cs-number-input form="f" name="a" value="1"></cs-number-input>
            </div>
          `);
        ...
        it('should not add a value to the form if disabled', async () => {
          const form = await fixture<HTMLFormElement>(
            html` <form><cs-number-input name="quantity" disabled required></cs-number-input></form>`,
          );
          const el = form.querySelector('cs-number-input')!;
          el.value = '5';
          await el.updateComplete;
        ...
        it('should submit with the correct form when the form attribute changes', async () => {
          const el = await fixture<HTMLFormElement>(html`
            <div>
              ...
              <cs-number-input form="f1" name="a" value="1"></cs-number-input>
            </div>
          `);
          const form = el.querySelector<HTMLFormElement>('#f2')!;
          const input = document.querySelector('cs-number-input')!;
        ...
        it('should reset the element to its initial value', async () => {
          const form = await fixture<HTMLFormElement>(html`
            <form>
              <cs-number-input name="a" value="5"></cs-number-input>
      ...
      describe('CSS parts and states', () => {
        ...
        it('should be invalid when required and empty', async () => {
          const el = await fixture<CsNumberInput>(html` <cs-number-input required></cs-number-input> `);
          expect(el.reportValidity()).to.be.false;
          expect(el.checkValidity()).to.be.false;
        });

        it('should be invalid when required and disabled is removed', async () => {
          const el = await fixture<CsNumberInput>(html` <cs-number-input disabled required></cs-number-input>`);
          expect(el.checkValidity()).to.be.true;
          el.disabled = false;
          await el.updateComplete;
          expect(el.checkValidity()).to.be.false;
        ...
        it('should receive the correct validation attributes ("states") when valid', async () => {
          const el = await fixture<CsNumberInput>(html` <cs-number-input required value="5"></cs-number-input> `);
        ...
        it('should receive validation attributes ("states") even when novalidate is used on the parent form', async () => {
          const el = await fixture<HTMLFormElement>(html`
            <form novalidate><cs-number-input required></cs-number-input></form>
          `);
          const input = el.querySelector<CsNumberInput>('cs-number-input')!;
        ...
        it('should be invalid when setCustomValidity() is called with a non-empty value', async () => {
          const input = await fixture<HTMLFormElement>(html` <cs-number-input></cs-number-input> `);
        ...
        it('should be invalid when the input is empty and form.reportValidity() is called', async () => {
          const form = await fixture<HTMLFormElement>(html`
            <form>
              <cs-number-input required value=""></cs-number-input>
              <cs-button type="submit">Submit</cs-button>
            </form>
          `);
