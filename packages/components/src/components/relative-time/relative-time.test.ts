...
import type CsRelativeTime from './relative-time.js';
...
describe('<cs-relative-time>', () => {
  for (const fixture of fixtures) {
    describe(`with "${fixture.type}" rendering`, () => {
      describe('properties', () => {
        it('should have correct default values', async () => {
          const el = await fixture<CsRelativeTime>(html`<cs-relative-time></cs-relative-time>`);
      ...
      describe('relative time formatting', () => {
        ...
        pastCases.forEach(({ offset, expected }) => {
          it(`should show "${expected}" for past date`, async () => {
            ...
            const el = await fixture<CsRelativeTime>(
              html`<cs-relative-time lang="en-US" .date="${date}"></cs-relative-time>`,
            );
      ...
      describe('numeric property', () => {
        it('should show human-readable form with numeric="auto"', async () => {
          ...
          const el = await fixture<CsRelativeTime>(
            html`<cs-relative-time lang="en-US" numeric="auto" .date="${yesterday}"></cs-relative-time>`,
          );
        ...
        it('should always show numeric form with numeric="always"', async () => {
          const yesterday = new Date(currentTime.getTime() - dayMs);
          const el = await fixture<CsRelativeTime>(
            html`<cs-relative-time lang="en-US" numeric="always" .date="${yesterday}"></cs-relative-time>`,
          );
      ...
      describe('format property', () => {
        it('should use long format by default', async () => {
          ...
          const el = await fixture<CsRelativeTime>(
            html`<cs-relative-time lang="en-US" numeric="always" .date="${twoYearsAgo}"></cs-relative-time>`,
          );
      ...
      describe('locale handling', () => {
        it('should format according to the specified locale', async () => {
          const yesterday = new Date(currentTime.getTime() - dayMs);
          const el = await fixture<CsRelativeTime>(
            html`<cs-relative-time lang="de-DE" numeric="auto" .date="${yesterday}"></cs-relative-time>`,
          );
      ...
      describe('time element attributes', () => {
        it('should set datetime attribute on the time element', async () => {
          const yesterday = new Date(currentTime.getTime() - dayMs);
          const el = await fixture<CsRelativeTime>(
            html`<cs-relative-time lang="en-US" .date="${yesterday}"></cs-relative-time>`,
          );
      ...
      describe('sync property', () => {
        it('should update the displayed value as time passes when sync is true', async () => {
          const yesterday = new Date(currentTime.getTime() - dayMs);
          const el = await fixture<CsRelativeTime>(
            html`<cs-relative-time lang="en-US" sync .date="${yesterday}"></cs-relative-time>`,
          );
      ...
      describe('edge cases', () => {
        it('should render nothing for an invalid date', async () => {
          const el = await fixture<CsRelativeTime>(
            html`<cs-relative-time lang="en-US" date="not-a-date"></cs-relative-time>`,
          );
