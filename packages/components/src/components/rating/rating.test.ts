...
import type CsRating from './rating.js';

describe('<cs-rating>', () => {
  runFormControlBaseTests({ tagName: 'cs-rating', formValue: { dirtyValue: 3 } });

  for (const fixture of fixtures) {
    describe(`with "${fixture.type}" rendering`, () => {
      describe('accessibility', () => {
        it('should pass accessibility tests', async () => {
          const el = await fixture<CsRating>(html`<cs-rating label="Test"></cs-rating>`);
        ...
        it('should not be focusable when disabled', async () => {
          const el = await fixture<CsRating>(html`<cs-rating label="Test" disabled></cs-rating>`);
          expect(el.tabIndex).to.equal(-1);
        });

        it('should not be focusable when readonly', async () => {
          const el = await fixture<CsRating>(html`<cs-rating label="Test" readonly></cs-rating>`);
          expect(el.tabIndex).to.equal(-1);
        });

        it('should set aria-label from label property', async () => {
          const el = await fixture<CsRating>(html`<cs-rating label="My Rating"></cs-rating>`);
      ...
      describe('properties', () => {
        it('should have correct default property values', async () => {
          const el = await fixture<CsRating>(html`<cs-rating></cs-rating>`);
      ...
      describe('events', () => {
        ...
        it('should not emit change when disabled', async () => {
          const el = await fixture<CsRating>(html`<cs-rating value="5" disabled></cs-rating>`);
          const lastSymbol = el.shadowRoot!.querySelector<HTMLSpanElement>('.symbol:last-child')!;
        ...
        it('should not emit change when the value is changed programmatically', async () => {
          const el = await fixture<CsRating>(html`<cs-rating value="1"></cs-rating>`);
      ...
      describe('keyboard navigation', () => {
        it('should increase value with ArrowRight', async () => {
          const el = await fixture<CsRating>(html`<cs-rating value="2"></cs-rating>`);
          el.focus();
          await el.updateComplete;
          await sendKeys({ press: 'ArrowRight' });
          await el.updateComplete;
        ...
        it('should not go below 0', async () => {
          const el = await fixture<CsRating>(html`<cs-rating value="0"></cs-rating>`);
          el.focus();
          await el.updateComplete;
          await sendKeys({ press: 'ArrowLeft' });
          await el.updateComplete;
        ...
        it('should not exceed max', async () => {
          const el = await fixture<CsRating>(html`<cs-rating value="5"></cs-rating>`);
          el.focus();
          await el.updateComplete;
          await sendKeys({ press: 'ArrowRight' });
          await el.updateComplete;
        ...
        it('should respect precision when navigating with arrow keys', async () => {
          const el = await fixture<CsRating>(html`<cs-rating value="2" precision="0.5"></cs-rating>`);
          el.focus();
          await el.updateComplete;
          await sendKeys({ press: 'ArrowRight' });
          await el.updateComplete;
        ...
        it('should not respond to keys when disabled', async () => {
          const el = await fixture<CsRating>(html`<cs-rating value="3" disabled></cs-rating>`);
          el.focus();
          await el.updateComplete;
          await sendKeys({ press: 'ArrowRight' });
          await el.updateComplete;
        ...
        it('should not respond to keys when readonly', async () => {
          const el = await fixture<CsRating>(html`<cs-rating value="3" readonly></cs-rating>`);
          el.focus();
          await el.updateComplete;
          await sendKeys({ press: 'ArrowRight' });
          await el.updateComplete;
      ...
      describe('form integration', () => {
        it('should reset to defaultValue when form is reset', async () => {
          const form = await fixture<HTMLFormElement>(html`
            <form>
              <cs-rating name="rating" value="3" default-value="1"></cs-rating>
              <button type="reset">Reset</button>
            </form>
          `);
          const rating = form.querySelector<CsRating>('cs-rating')!;
      ...
      describe('CSS parts', () => {
        it('should expose the base part', async () => {
          const el = await fixture<CsRating>(html`<cs-rating></cs-rating>`);
          const base = el.shadowRoot!.querySelector('[part~="rating"]');
