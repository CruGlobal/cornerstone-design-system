...
import type CsSplitPanel from './split-panel.js';

describe('<cs-split-panel>', () => {
  afterEach(async () => {
    ...
    describe(`with "${fixture.type}" rendering`, () => {
      describe('accessibility', () => {
        it('should be accessible', async () => {
          const el = await fixture<CsSplitPanel>(
            html`<cs-split-panel>
      ...
      describe('properties', () => {
        it('should have a default position of 50', async () => {
          const el = await fixture<CsSplitPanel>(html`<cs-split-panel></cs-split-panel>`);
        ...
        it('should accept position via attribute', async () => {
          const el = await fixture<CsSplitPanel>(html`<cs-split-panel position="25"></cs-split-panel>`);
        ...
        it('should reflect orientation to attribute', async () => {
          const el = await fixture<CsSplitPanel>(html`<cs-split-panel orientation="vertical"></cs-split-panel>`);
        ...
        it('should reflect disabled to attribute', async () => {
          const el = await fixture<CsSplitPanel>(html`<cs-split-panel disabled></cs-split-panel>`);
      ...
      describe('events', () => {
        it('should emit cs-reposition when position changes', async () => {
          const el = await fixture<CsSplitPanel>(
            html`<cs-split-panel>
              <div slot="start">Start</div>
              <div slot="end">End</div>
          ...
          await expectEvent(el, 'cs-reposition', () => {
            el.position = 10;
          });
        });
      });
      ...
      describe('keyboard navigation', () => {
        ...
        it('should move position up on ArrowUp in vertical mode', async () => {
          const el = await fixture<CsSplitPanel>(
            html`<cs-split-panel orientation="vertical" style="height: 400px;">
              <div slot="start">Start</div>
              <div slot="end">End</div>
            </cs-split-panel>`,
          );
