...
import type CsDrawer from '../drawer/drawer.js';
import '../icon/icon.js';
 ...
 * @csspart navigation-header - The header for a navigation area. On mobile this will be the header for `<cs-drawer>`.
 * @csspart navigation-footer - The footer for a navigation area. On mobile this will be the footer for `<cs-drawer>`.
 * @csspart navigation-toggle - The default `<cs-button>` that will toggle the `<cs-drawer>` for mobile viewports.
 * @csspart navigation-toggle-icon - The default `<cs-icon>` displayed inside of the navigation-toggle button.
 * @csspart drawer - The `<cs-drawer>` that contains the navigation on mobile viewports.
 * @csspart drawer__dialog - The navigation drawer's `dialog` part.
 * @csspart drawer__header - The navigation drawer's `header` part.
 * @csspart drawer__header-actions - The navigation drawer's `header-actions` part.
 * @csspart drawer__title - The navigation drawer's `title` part.
 * @csspart drawer__close-button - The navigation drawer's close button.
 * @csspart drawer__close-button__button - The navigation drawer's close button's `button` part.
 * @csspart drawer__body - The navigation drawer's `body` part.
 * @csspart drawer__footer - The navigation drawer's `footer` part.
...
export default class CsPage extends CornerstoneElement {
  ...
  @query("[part~='drawer']") navigationDrawer: CsDrawer;
