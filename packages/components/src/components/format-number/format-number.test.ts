...
import type CsFormatNumber from './format-number.js';

describe('<cs-format-number>', () => {
  for (const fixture of fixtures) {
    describe(`with "${fixture.type}" rendering`, () => {
      describe('properties', () => {
        it('should have correct default values', async () => {
          const el = await fixture<CsFormatNumber>(html`<cs-format-number></cs-format-number>`);
      ...
      describe('type formatting', () => {
        it('should format as decimal by default', async () => {
          const el = await fixture<CsFormatNumber>(html`<cs-format-number value="1000"></cs-format-number>`);
        ...
        it('should format as currency', async () => {
          const el = await fixture<CsFormatNumber>(
            html`<cs-format-number value="1000" type="currency"></cs-format-number>`,
          );
        ...
        it('should format as percent', async () => {
          const el = await fixture<CsFormatNumber>(
            html`<cs-format-number value="0.5" type="percent"></cs-format-number>`,
          );
      ...
      describe('locale formatting', () => {
        ['de', 'fr', 'ja', 'ru'].forEach((lang) => {
          it(`should format correctly for locale: ${lang}`, async () => {
            const el = await fixture<CsFormatNumber>(
              html`<cs-format-number value="1000" lang="${lang}"></cs-format-number>`,
            );
      ...
      describe('grouping', () => {
        ...
        it('should omit grouping separators when without-grouping is set', async () => {
          const el = await fixture<CsFormatNumber>(
            html`<cs-format-number value="1000" without-grouping></cs-format-number>`,
          );
      ...
      describe('currency options', () => {
        ['USD', 'CAD', 'EUR', 'GBP'].forEach((currency) => {
          it(`should format with currency: ${currency}`, async () => {
            const el = await fixture<CsFormatNumber>(
              html`<cs-format-number value="1000" type="currency" currency="${currency}"></cs-format-number>`,
            );
        ...
        (['symbol', 'narrowSymbol', 'code', 'name'] as const).forEach((display) => {
          it(`should format with currency display: ${display}`, async () => {
            const el = await fixture<CsFormatNumber>(
              html`<cs-format-number value="1000" type="currency" currency-display="${display}"></cs-format-number>`,
            );
      ...
      describe('digit options', () => {
        it('should respect minimum-integer-digits', async () => {
          const el = await fixture<CsFormatNumber>(
            html`<cs-format-number value="5" minimum-integer-digits="4"></cs-format-number>`,
          );
        ...
        it('should respect minimum-fraction-digits', async () => {
          const el = await fixture<CsFormatNumber>(
            html`<cs-format-number value="1.5" minimum-fraction-digits="3"></cs-format-number>`,
          );
        ...
        it('should respect maximum-fraction-digits', async () => {
          const el = await fixture<CsFormatNumber>(
            html`<cs-format-number value="1.23456" maximum-fraction-digits="2"></cs-format-number>`,
          );
        ...
        it('should respect minimum-significant-digits', async () => {
          const el = await fixture<CsFormatNumber>(
            html`<cs-format-number value="1000" minimum-significant-digits="5"></cs-format-number>`,
          );
        ...
        it('should respect maximum-significant-digits', async () => {
          const el = await fixture<CsFormatNumber>(
            html`<cs-format-number value="123456" maximum-significant-digits="3"></cs-format-number>`,
          );
      ...
      describe('edge cases', () => {
        ...
        it('should format zero correctly', async () => {
          const el = await fixture<CsFormatNumber>(html`<cs-format-number value="0"></cs-format-number>`);
          const expected = new Intl.NumberFormat('en-US', { style: 'decimal' }).format(0);
          expect(el.shadowRoot?.textContent).to.equal(expected);
        });

        it('should format negative numbers', async () => {
          const el = await fixture<CsFormatNumber>(html`<cs-format-number value="-1234"></cs-format-number>`);
