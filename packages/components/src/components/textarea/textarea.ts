...
export default class CsTextarea extends CornerstoneFormAssociatedElement {
  ...
  @query('[part~="textarea-wrapper"]') base: HTMLDivElement;
...
// The change-in-update warning is required for this component because the base class (CornerstoneFormAssociatedElement)
