...
import type CsRadio from '../radio/radio.js';
import type CsRadioGroup from './radio-group.js';

describe('<cs-radio-group>', () => {
  runFormControlBaseTests({ tagName: 'cs-radio-group', formValue: { dirtyValue: 'b' } });

  for (const fixture of fixtures) {
    describe(`with "${fixture.type}" rendering`, () => {
      describe('accessibility', () => {
        it('should pass accessibility tests', async () => {
          const el = await fixture<CsRadioGroup>(
            html`<cs-radio-group label="Pick one"
              ><cs-radio value="1">One</cs-radio><cs-radio value="2">Two</cs-radio></cs-radio-group
            >`,
          );
      ...
      describe('properties', () => {
        ...
        it('should check the correct radio when value is set', async () => {
          ...
          `);
          const radios = el.querySelectorAll('cs-radio');
      ...
      describe('validation', () => {
        it('should be invalid initially when required and no radio is checked', async () => {
          const el = await fixture<CsRadioGroup>(html`
            <cs-radio-group required>
              <cs-radio value="1"></cs-radio>
              <cs-radio value="2"></cs-radio>
            </cs-radio-group>
          `);
        ...
        it('should be valid when required and one radio is checked', async () => {
          const el = await fixture<CsRadioGroup>(html`
            <cs-radio-group label="Select an option" value="1" required>
        ...
        it('should be invalid when required and no radios are checked', async () => {
          const el = await fixture<CsRadioGroup>(html`
            <cs-radio-group label="Select an option" required>
              <cs-radio value="1">Option 1</cs-radio>
              <cs-radio value="2">Option 2</cs-radio>
              <cs-radio value="3">Option 3</cs-radio>
            </cs-radio-group>
        ...
        it('should be valid when required and a different radio is checked', async () => {
          const el = await fixture<CsRadioGroup>(html`
            <cs-radio-group label="Select an option" value="3" required>
              <cs-radio value="1">Option 1</cs-radio>
              <cs-radio value="2">Option 2</cs-radio>
              <cs-radio value="3">Option 3</cs-radio>
            </cs-radio-group>
        ...
        it('should be invalid when custom validity is set', async () => {
          const el = await fixture<CsRadioGroup>(html`
            <cs-radio-group label="Select an option">
              <cs-radio value="1">Option 1</cs-radio>
              <cs-radio value="2">Option 2</cs-radio>
              <cs-radio value="3">Option 3</cs-radio>
            </cs-radio-group>
        ...
        it('should receive the correct validation attributes ("states") when valid', async () => {
          const el = await fixture<CsRadioGroup>(html`
            <cs-radio-group value="1" required>
              <cs-radio value="1"></cs-radio>
              <cs-radio value="2"></cs-radio>
            </cs-radio-group>
          `);
          const secondRadio = el.querySelectorAll('cs-radio')[1];
        ...
        it('should receive validation attributes ("states") even when novalidate is used on the parent form', async () => {
          ...
          `);
          const radioGroup = el.querySelector<CsRadioGroup>('cs-radio-group')!;
          ...
          const form = await fixture<HTMLFormElement>(html`
            <form>
              <cs-radio-group value="1">
                <cs-radio id="radio-1" name="a" value="1"></cs-radio>
                <cs-radio id="radio-2" name="a" value="2"></cs-radio>
              </cs-radio-group>
              <cs-button type="submit">Submit</cs-button>
            </form>
          `);
          const button = form.querySelector('cs-button')!;
          const radioGroup = form.querySelector<CsRadioGroup>('cs-radio-group')!;
      ...
      describe('events', () => {
        it('should emit change and input when toggled with arrow keys', async () => {
          ...
          `);
          const firstRadio = el.querySelector<CsRadio>('#radio-1')!;
        ...
        it('should emit change and input when clicked', async () => {
          ...
          `);
          const radio = el.querySelector<CsRadio>('#radio-1')!;
      ...
      describe('keyboard navigation', () => {
        ...
        it('should wrap from first to last radio with ArrowLeft', async () => {
          ...
          `);
          const firstRadio = el.querySelectorAll('cs-radio')[0];
          firstRadio.focus();
        ...
        it('should skip disabled radios', async () => {
          const el = await fixture<CsRadioGroup>(html`
            <cs-radio-group value="1">
              <cs-radio value="1"></cs-radio>
              <cs-radio value="2" disabled></cs-radio>
              <cs-radio value="3"></cs-radio>
            </cs-radio-group>
          `);
          const firstRadio = el.querySelectorAll('cs-radio')[0];
          firstRadio.focus();
      ...
      describe('focus handling', () => {
        const doAction = async (instance: CsRadioGroup, type: string) => {
          if (type === 'focus') {
            instance.focus();
        ...
        ['focus', 'label'].forEach((actionType) => {
          describe(`when using ${actionType}`, () => {
            it('should do nothing if all elements are disabled', async () => {
              const el = await fixture<CsRadioGroup>(html`
                <cs-radio-group>
                  <cs-radio id="radio-0" value="0" disabled></cs-radio>
                  <cs-radio id="radio-1" value="1" disabled></cs-radio>
              ...
              Array.from(el.querySelectorAll<CsRadio>('cs-radio')).forEach((radio) =>
            ...
            it('should focus the checked radio when the group receives focus', async () => {
              const el = await fixture<CsRadioGroup>(html`
                <cs-radio-group value="2">
                  <cs-radio id="radio-0" value="0" disabled></cs-radio>
                  <cs-radio id="radio-1" value="1"></cs-radio>
                  <cs-radio id="radio-2" value="2" checked></cs-radio>
                  <cs-radio id="radio-3" value="3"></cs-radio>
                </cs-radio-group>
              `);
      ...
      describe('form integration', () => {
        it('should submit the correct value when a value is provided', async () => {
          ...
          const radio = form.querySelectorAll('cs-radio')[1];
          radio.click();
          await form.querySelector('cs-radio-group')?.updateComplete;
        ...
        it('should be present in form data when using the form attribute and located outside of a <form>', async () => {
          const el = await fixture<HTMLFormElement>(html`
            <div>
              ...
              <cs-radio-group form="f" name="a" value="1">
                <cs-radio id="radio-1" value="1"></cs-radio>
                <cs-radio id="radio-2" value="2"></cs-radio>
                <cs-radio id="radio-3" value="3"></cs-radio>
              </cs-radio-group>
      ...
      describe('regression tests', () => {
        ...
        it('should respond to attribute changes if the value has not changed', async () => {
          const el = await fixture<CsRadioGroup>(html`
            <cs-radio-group value="2">
              <cs-radio value="0">0</cs-radio>
              <cs-radio value="1">1</cs-radio>
              <cs-radio value="2">2</cs-radio>
              <cs-radio value="3">3</cs-radio>
              <cs-radio value="4">4</cs-radio>
            </cs-radio-group>
          `);

          expect(el.querySelectorAll('cs-radio')[2].checked).to.equal(true);
          el.setAttribute('value', '4');
          await el.updateComplete;
          expect(el.value).to.equal('4');
          expect(el.querySelectorAll('cs-radio')[4].checked).to.equal(true);
        });
