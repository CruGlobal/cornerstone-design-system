...
export default class CsDetails extends CornerstoneElement {
  static css = styles;
  ...
  private handleSummaryClick(event: MouseEvent) {
    ...
    const hasInteractiveElement = eventPath.some((element) => {
      ...
      // Check for Cornerstone form controls
  ...
  private closeOthersWithSameName() {
    ...
    const otherDetails = root.querySelectorAll<CsDetails>(`cs-details[name="${this.name}"]`);
