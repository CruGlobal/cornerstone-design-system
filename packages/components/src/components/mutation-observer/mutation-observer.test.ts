...
import type CsMutationObserver from './mutation-observer.js';

describe('<cs-mutation-observer>', () => {
  for (const fixture of fixtures) {
    describe(`with "${fixture.type}" rendering`, () => {
      describe('properties', () => {
        it('should have default property values', async () => {
          const el = await fixture<CsMutationObserver>(html`<cs-mutation-observer></cs-mutation-observer>`);
        ...
        it('should reflect the "disabled" property to an attribute', async () => {
          const el = await fixture<CsMutationObserver>(html`<cs-mutation-observer disabled></cs-mutation-observer>`);
        ...
        it('should reflect the "attr" property to an attribute', async () => {
          const el = await fixture<CsMutationObserver>(
            html`<cs-mutation-observer attr="class"></cs-mutation-observer>`,
          );
        ...
        it('should reflect the "attr-old-value" property to an attribute', async () => {
          const el = await fixture<CsMutationObserver>(
            html`<cs-mutation-observer attr="*" attr-old-value></cs-mutation-observer>`,
          );
        ...
        it('should reflect the "char-data" property to an attribute', async () => {
          const el = await fixture<CsMutationObserver>(html`<cs-mutation-observer char-data></cs-mutation-observer>`);
        ...
        it('should reflect the "char-data-old-value" property to an attribute', async () => {
          const el = await fixture<CsMutationObserver>(
            html`<cs-mutation-observer char-data char-data-old-value></cs-mutation-observer>`,
          );
        ...
        it('should reflect the "child-list" property to an attribute', async () => {
          const el = await fixture<CsMutationObserver>(html`<cs-mutation-observer child-list></cs-mutation-observer>`);
      ...
      describe('events', () => {
        it('should emit cs-mutation when a watched attribute changes', async () => {
          const handler = sinon.spy();

          const el = await fixture<CsMutationObserver>(html`
            <cs-mutation-observer attr="class">
              <div class="initial">Hello</div>
            </cs-mutation-observer>
          `);

          el.addEventListener('cs-mutation', handler);

          // Trigger a mutation by changing the class attribute
          const child = el.querySelector('div')!;
          child.classList.add('changed');

          await waitUntil(() => handler.called, 'cs-mutation event should fire');
        ...
        it('should emit cs-mutation when watching all attributes with "*"', async () => {
          const handler = sinon.spy();

          const el = await fixture<CsMutationObserver>(html`
            <cs-mutation-observer attr="*">
              <div>Hello</div>
            </cs-mutation-observer>
          `);
        ...
        it('should only watch specified attributes when a filter is provided', async () => {
          ...
          await waitUntil(() => handler.called, 'cs-mutation event should fire for watched attribute');
          expect(handler).to.have.been.called;
        });

        it('should emit cs-mutation when child-list changes', async () => {
          const handler = sinon.spy();
          ...
          await waitUntil(() => handler.called, 'cs-mutation event should fire for child list change');
        ...
        it('should not emit events when disabled', async () => {
          ...
          const el = await fixture<CsMutationObserver>(html`
            <cs-mutation-observer attr="class" disabled>
              <div class="initial">Hello</div>
            </cs-mutation-observer>
          `);
        ...
        it('should resume observing after being re-enabled', async () => {
          ...
          await waitUntil(() => handler.called, 'cs-mutation event should fire after re-enabling');
          expect(handler).to.have.been.called;
        });
      });
