...
import { CsCopyEvent } from '../../events/copy.js';
...
const INTERNAL_TOOLTIP_SLOT = 'cs-internal-tooltip';
...
export default class CsCopyButton extends CornerstoneElement {
  ...
  @query('cs-tooltip[part="feedback"]') shadowTooltip: CsTooltip;
  ...
  private lightTooltip: CsTooltip | null = null;
  private feedbackTimeout: number | null = null;

  private get activeTooltip(): CsTooltip | null {
