...
import type CsCopyButton from './copy-button.js';

const ignoredRules: string[] = [];

describe('<cs-copy-button>', () => {
  afterEach(() => {
    sinon.restore();
  });
    ...
    describe(`with "${fixture.type}" rendering`, () => {
      describe('accessibility', () => {
        it('should pass accessibility tests', async () => {
          const el = await fixture<CsCopyButton>(html`<cs-copy-button value="something"></cs-copy-button>`);
      ...
      describe('properties', () => {
        it('should have a default value of empty string', async () => {
          const el = await fixture<CsCopyButton>(html`<cs-copy-button></cs-copy-button>`);
          expect(el.value).to.equal('');
        });

        it('should accept a value property', async () => {
          const el = await fixture<CsCopyButton>(html`<cs-copy-button value="hello world"></cs-copy-button>`);
        ...
        it('should accept a from property', async () => {
          const el = await fixture<CsCopyButton>(html`<cs-copy-button from="my-input"></cs-copy-button>`);
        ...
        it('should reflect disabled to attribute', async () => {
          const el = await fixture<CsCopyButton>(html`<cs-copy-button disabled></cs-copy-button>`);
        ...
        it('should accept custom label properties', async () => {
          const el = await fixture<CsCopyButton>(html`
            <cs-copy-button
              value="test"
              copy-label="Copy it"
              success-label="Done"
      ...
      describe('events', () => {
        it('should emit cs-copy on successful copy', async () => {
          // Stub clipboard API
          sinon.stub(navigator.clipboard, 'writeText').resolves();

          const el = await fixture<CsCopyButton>(html`<cs-copy-button value="test value"></cs-copy-button>`);

          const events = await expectEvent(el, 'cs-copy', async () => {
        ...
        it('should emit cs-error when copy fails', async () => {
        ...
        it('should emit cs-error when value is empty', async () => {
          const el = await fixture<CsCopyButton>(html`<cs-copy-button value=""></cs-copy-button>`);
        ...
        it('should not copy when disabled', async () => {
          ...
          const el = await fixture<CsCopyButton>(html`<cs-copy-button value="test" disabled></cs-copy-button>`);
      ...
      describe('status states', () => {
        it('should change status to success after copying', async () => {
          ...
          const el = await fixture<CsCopyButton>(
            html`<cs-copy-button value="test" feedback-duration="200"></cs-copy-button>`,
          );
        ...
        it('should reset status to rest after feedbackDuration', async () => {
          ...
          const el = await fixture<CsCopyButton>(
            html`<cs-copy-button value="test" feedback-duration="100"></cs-copy-button>`,
          );
      ...
      describe('from property', () => {
        it('should copy textContent from referenced element', async () => {
          ...
          const container = await fixture<HTMLDivElement>(html`
            <div>
              ...
              <cs-copy-button from="source-el"></cs-copy-button>
            </div>
          `);

          const el = container.querySelector<CsCopyButton>('cs-copy-button')!;
          await clickOnElement(el);
        ...
        it('should copy attribute value using bracket syntax', async () => {
          ...
          const container = await fixture<HTMLDivElement>(html`
            <div>
              ...
              <cs-copy-button from="source-input[value]"></cs-copy-button>
            </div>
          `);
        ...
        it('should copy property value using dot syntax', async () => {
          ...
          const container = await fixture<HTMLDivElement>(html`
            <div>
              ...
              <cs-copy-button from="source-prop.value"></cs-copy-button>
            </div>
          `);
        ...
        it('should emit cs-error when referenced element is not found', async () => {
          const el = await fixture<CsCopyButton>(html`<cs-copy-button from="nonexistent-element"></cs-copy-button>`);
      ...
      describe('custom trigger tooltip', () => {
        it('should auto-assign an id to a custom trigger that has none', async () => {
          ...
          expect(trigger.id).to.match(/^cs-copy-button-trigger-/);
        });
        ...
        it('should append a light-DOM tooltip anchored to the custom trigger', async () => {
          ...
          const trigger = el.querySelector<HTMLButtonElement>('button')!;
          const tooltip = el.querySelector<CsTooltip>('cs-tooltip[slot="cs-internal-tooltip"]')!;
        ...
        it('should activate tooltip on hover of custom trigger when tooltip="full"', async () => {
          const el = await fixture<CsCopyButton>(html`
            <cs-copy-button value="test" tooltip="full">
              <button>Custom Copy</button>
            </cs-copy-button>
          `);
          ...
          // Wait for showDelay (150ms default) + buffer. `waitUntil` defaults to a 1000ms budget, which
          // this hover clears alone but misses under full-suite load with three browsers in flight —
          // the one baseline failure that isolated re-runs always cleared. The behaviour is fine; the
          // budget was not.
          await waitUntil(() => tooltip.open === true, 'tooltip never opened on hover', { timeout: 3000 });
        ...
        it('should render a tooltip with hover/focus trigger when tooltip="full" on the default trigger', async () => {
          const el = await fixture<CsCopyButton>(html`<cs-copy-button value="test" tooltip="full"></cs-copy-button>`);
          // With SSR for copy-button, we need to wait for the first update and the following update to complete.
          el.requestUpdate();
          await el.updateComplete;

          const tooltip = el.shadowRoot!.querySelector<CsTooltip>('cs-tooltip')!;
          expect(tooltip).to.exist;
        ...
        it('should render a tooltip with manual trigger when tooltip="copy" on the default trigger', async () => {
          const el = await fixture<CsCopyButton>(html`<cs-copy-button value="test" tooltip="copy"></cs-copy-button>`);
          // With SSR for copy-button, we need to wait for the first update and the following update to complete.
          el.requestUpdate();
          await el.updateComplete;
          const tooltip = el.shadowRoot!.querySelector<CsTooltip>('cs-tooltip')!;
        ...
        it('should render a tooltip with manual trigger when tooltip="copy" on a custom trigger', async () => {
          const el = await fixture<CsCopyButton>(html`
            <cs-copy-button value="test" tooltip="copy">
              <button>Custom Copy</button>
            </cs-copy-button>
          `);
          await el.updateComplete;
        ...
        it('should open the feedback-mode tooltip during copy', async () => {
          ...
          const el = await fixture<CsCopyButton>(html`
            <cs-copy-button value="test" tooltip="copy" feedback-duration="2000">
              <button>Custom Copy</button>
            </cs-copy-button>
          `);
          await el.updateComplete;
        ...
        it('should not render any tooltip when tooltip="none" on a custom trigger', async () => {
          const el = await fixture<CsCopyButton>(html`
            <cs-copy-button value="test" tooltip="none">
              <button>Custom Copy</button>
            </cs-copy-button>
          `);
          await el.updateComplete;

          expect(el.querySelector('cs-tooltip[slot="cs-internal-tooltip"]')).to.be.null;
        });

        it('should not render any tooltip when tooltip="none" on the default trigger', async () => {
          const el = await fixture<CsCopyButton>(html`<cs-copy-button value="test" tooltip="none"></cs-copy-button>`);
          expect(el.shadowRoot!.querySelector('cs-tooltip')).to.be.null;
        });
        ...
        it('should not render or open a tooltip during copy when tooltip="none"', async () => {
          ...
          const el = await fixture<CsCopyButton>(html`
            <cs-copy-button value="test" tooltip="none" feedback-duration="200">
              <button>Custom Copy</button>
            </cs-copy-button>
          `);
          await el.updateComplete;
        ...
        it('should clean up the light-DOM tooltip on disconnect', async () => {
          ...
          expect(container.querySelector('cs-tooltip[slot="cs-internal-tooltip"]')).to.exist;

          el.remove();

          expect(container.querySelector('cs-tooltip[slot="cs-internal-tooltip"]')).to.be.null;
        });
      });

      describe('CSS parts and states', () => {
        it('should expose the button CSS part', async () => {
          const el = await fixture<CsCopyButton>(html`<cs-copy-button value="test"></cs-copy-button>`);
