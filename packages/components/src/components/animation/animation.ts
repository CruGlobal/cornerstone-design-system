...
import { CsCancelEvent } from '../../events/cancel.js';
import { CsFinishEvent } from '../../events/finish.js';
import { CsStartEvent } from '../../events/start.js';
...
export default class CsAnimation extends CornerstoneElement {
  static css = styles;
  ...
  /**
   * The easing function to use for the animation. This can be a Cornerstone easing function or a custom easing function
