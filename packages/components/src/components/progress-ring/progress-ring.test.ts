...
import type CsProgressRing from './progress-ring.js';

describe('<cs-progress-ring>', () => {
  for (const fixture of fixtures) {
    describe(`with "${fixture.type}" rendering`, () => {
      describe('accessibility', () => {
        it('should be accessible with default properties', async () => {
          const el = await fixture<CsProgressRing>(html`<cs-progress-ring value="25"></cs-progress-ring>`);
          await expect(el).to.be.accessible();
        });

        it('should be accessible with a custom label', async () => {
          const el = await fixture<CsProgressRing>(
            html`<cs-progress-ring value="50" label="Loading"></cs-progress-ring>`,
          );
          await expect(el).to.be.accessible();
        });
      });
      ...
      describe('properties', () => {
        it('should have default property values', async () => {
          const el = await fixture<CsProgressRing>(html`<cs-progress-ring></cs-progress-ring>`);
        ...
        it('should reflect the value attribute', async () => {
          const el = await fixture<CsProgressRing>(html`<cs-progress-ring value="75"></cs-progress-ring>`);
        ...
        it('should set aria-valuenow from value', async () => {
          const el = await fixture<CsProgressRing>(html`<cs-progress-ring value="25"></cs-progress-ring>`);
          const base = el.shadowRoot!.querySelector('[part~="progress-ring"]')!;
        ...
        it('should use custom label for aria-label when provided', async () => {
          const el = await fixture<CsProgressRing>(
            html`<cs-progress-ring value="50" label="Uploading"></cs-progress-ring>`,
          );
          const base = el.shadowRoot!.querySelector('[part~="progress-ring"]')!;
        ...
        it('should have proper ARIA progressbar role', async () => {
          const el = await fixture<CsProgressRing>(html`<cs-progress-ring value="50"></cs-progress-ring>`);
          const base = el.shadowRoot!.querySelector('[part~="progress-ring"]')!;
      ...
      describe('slots', () => {
        it('should render the default slot for the label', async () => {
          const el = await fixture<CsProgressRing>(html`<cs-progress-ring value="50">50%</cs-progress-ring>`);
      ...
      describe('CSS parts', () => {
        it('should have a base part', async () => {
          const el = await fixture<CsProgressRing>(html`<cs-progress-ring value="50"></cs-progress-ring>`);
          expect(el.shadowRoot!.querySelector('[part~="progress-ring"]')).to.exist;
        });
