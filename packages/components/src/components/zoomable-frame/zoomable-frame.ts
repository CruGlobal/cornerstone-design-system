...
export default class CsZoomableFrame extends CornerstoneElement {
  static css = styles;
  ...
  private syncTheme() {
    ...
    try {
      ...
      const schemeCls = new Set<string>(); // cs-dark or cs-light
      const themeCls = new Set<string>(); // cs-theme-*, etc.
      // eslint-disable-next-line @typescript-eslint/no-this-alias -- the walk starts at the host
...
declare global {
  interface HTMLElementTagNameMap {
    'cs-zoomable-frame': CsZoomableFrame;
  }
}
