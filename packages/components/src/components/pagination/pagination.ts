...
import { CsAfterPageChangeEvent } from '../../events/after-page-change.js';
import { CsPageChangeEvent } from '../../events/page-change.js';
...
export default class CsPagination extends CornerstoneElement {
  static css = styles;
