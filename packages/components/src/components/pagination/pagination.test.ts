...
import type CsPagination from './pagination.js';

/** Returns the visible page-number buttons/links (excludes nav and ellipsis). */
function getPageButtons(el: CsPagination) {
  return [...el.shadowRoot!.querySelectorAll<HTMLElement>('[part~="page"]')];
}

function getButtonByPart(el: CsPagination, part: string) {
 ...
 */
function renderedRange(el: CsPagination): string {
...
describe('<cs-pagination>', () => {
  for (const fixture of fixtures) {
    describe(`with "${fixture.type}" rendering`, () => {
      describe('accessibility', () => {
        it('should be accessible', async () => {
          const el = await fixture<CsPagination>(
            html`<cs-pagination total="237" page-size="10" page="3"></cs-pagination>`,
          );
          await expect(el).to.be.accessible();
        });

        it('should render a <nav> landmark with a localized label', async () => {
          const el = await fixture<CsPagination>(html`<cs-pagination total="100" page-size="10"></cs-pagination>`);
        ...
        it('should allow the nav label to be overridden', async () => {
          const el = await fixture<CsPagination>(
            html`<cs-pagination total="100" page-size="10" label="Search results"></cs-pagination>`,
          );
        ...
        it('should mark exactly one item with aria-current="page"', async () => {
          const el = await fixture<CsPagination>(
            html`<cs-pagination total="200" page-size="10" page="3"></cs-pagination>`,
          );
        ...
        it('should NOT add aria-label to numbered items (visible number is the name)', async () => {
          const el = await fixture<CsPagination>(
            html`<cs-pagination total="50" page-size="10" page="1"></cs-pagination>`,
          );
        ...
        it('should give icon-only nav buttons localized aria-labels', async () => {
          const el = await fixture<CsPagination>(
            html`<cs-pagination total="200" page-size="10" page="3" with-edges></cs-pagination>`,
          );
        ...
        it('should render the list with role="list"/"listitem"', async () => {
          const el = await fixture<CsPagination>(html`<cs-pagination total="50" page-size="10"></cs-pagination>`);
        ...
        it('should render a labeled ellipsis button for collapsed pages', async () => {
          const el = await fixture<CsPagination>(
            html`<cs-pagination total="500" page-size="10" page="25"></cs-pagination>`,
          );
        ...
        it('should clamp an ellipsis jump to the last page', async () => {
          const el = await fixture<CsPagination>(
            html`<cs-pagination total="500" page-size="10" page="47"></cs-pagination>`,
          );
      ...
      describe('math & properties', () => {
        it('should compute totalPages from total and pageSize', async () => {
          const el = await fixture<CsPagination>(html`<cs-pagination total="237" page-size="10"></cs-pagination>`);
          expect(el.totalPages).to.equal(24);
        });

        it('should always have at least one page', async () => {
          const el = await fixture<CsPagination>(html`<cs-pagination total="0" page-size="10"></cs-pagination>`);
          expect(el.totalPages).to.equal(1);
        });

        it('should clamp an out-of-range page', async () => {
          const el = await fixture<CsPagination>(
            html`<cs-pagination total="50" page-size="10" page="99"></cs-pagination>`,
          );
          await el.updateComplete;
        ...
        it('should reflect page to an attribute', async () => {
          const el = await fixture<CsPagination>(
            html`<cs-pagination total="50" page-size="10" page="3"></cs-pagination>`,
          );
        ...
        it('should clamp the page property when set above the last page after mount', async () => {
          const el = await fixture<CsPagination>(
            html`<cs-pagination total="50" page-size="10" page="2"></cs-pagination>`,
          );
          el.page = 99;
          await el.updateComplete;
          expect(el.page).to.equal(5);
      ...
      describe('events', () => {
        it('should emit cs-after-page-change with { page, pageSize } when a page is clicked', async () => {
          const el = await fixture<CsPagination>(
            html`<cs-pagination total="200" page-size="10" page="1"></cs-pagination>`,
          );
          const handler = sinon.spy();
          el.addEventListener('cs-after-page-change', handler);
        ...
        it('should NOT emit cs-after-page-change on first render', async () => {
          const handler = sinon.spy();
          const el = await fixture<CsPagination>(
            html`<cs-pagination total="200" page-size="10" page="2"></cs-pagination>`,
          );
          el.addEventListener('cs-after-page-change', handler);
          await el.updateComplete;
        ...
        it('should emit cs-page-change before cs-after-page-change', async () => {
          const el = await fixture<CsPagination>(
            html`<cs-pagination total="200" page-size="10" page="1"></cs-pagination>`,
          );
          const order: string[] = [];
          el.addEventListener('cs-page-change', () => order.push('before'));
          el.addEventListener('cs-after-page-change', () => order.push('after'));
        ...
        it('should let cs-page-change veto the change', async () => {
          const el = await fixture<CsPagination>(
            html`<cs-pagination total="200" page-size="10" page="1"></cs-pagination>`,
          );
          const afterHandler = sinon.spy();
          el.addEventListener('cs-page-change', (event) => event.preventDefault());
          el.addEventListener('cs-after-page-change', afterHandler);
      ...
      describe('navigation buttons', () => {
        it('should advance with next and go back with previous', async () => {
          const el = await fixture<CsPagination>(
            html`<cs-pagination total="200" page-size="10" page="5"></cs-pagination>`,
          );
          getButtonByPart(el, 'next-button')!.click();
          await el.updateComplete;
        ...
        it('should jump to first and last with edge buttons', async () => {
          const el = await fixture<CsPagination>(
            html`<cs-pagination total="200" page-size="10" page="10" with-edges></cs-pagination>`,
          );
        ...
        it('should hide nav buttons with without-nav', async () => {
          const el = await fixture<CsPagination>(
            html`<cs-pagination total="200" page-size="10" without-nav></cs-pagination>`,
          );
      ...
      describe('boundary semantics', () => {
        it('should mark previous/first as aria-disabled on the first page (not native disabled)', async () => {
          const el = await fixture<CsPagination>(
            html`<cs-pagination total="200" page-size="10" page="1" with-edges></cs-pagination>`,
          );
        ...
        it('should mark next/last as aria-disabled on the last page', async () => {
          const el = await fixture<CsPagination>(
            html`<cs-pagination total="200" page-size="10" page="20" with-edges></cs-pagination>`,
          );
      ...
      describe('disabled', () => {
        it('should set the disabled custom state', async () => {
          const el = await fixture<CsPagination>(
            html`<cs-pagination total="200" page-size="10" disabled></cs-pagination>`,
          );
          el.disabled = false;
          await el.updateComplete;
          el.disabled = true;
        ...
        it('should not change pages when disabled', async () => {
          const el = await fixture<CsPagination>(
            html`<cs-pagination total="200" page-size="10" page="2" disabled></cs-pagination>`,
          );
      ...
      describe('hide-single-page', () => {
        it('should render nothing when there is one page', async () => {
          const el = await fixture<CsPagination>(
            html`<cs-pagination total="5" page-size="10" hide-single-page></cs-pagination>`,
          );
        ...
        it('should render when there is more than one page', async () => {
          const el = await fixture<CsPagination>(
            html`<cs-pagination total="50" page-size="10" hide-single-page></cs-pagination>`,
          );
      ...
      describe('format', () => {
        it('should default to the standard layout (full page list)', async () => {
          const el = await fixture<CsPagination>(
            html`<cs-pagination total="237" page-size="10" page="1"></cs-pagination>`,
          );
        ...
        it('should render a "1 of N" label and no page numbers in the compact format', async () => {
          const el = await fixture<CsPagination>(
            html`<cs-pagination total="237" page-size="10" page="1" format="compact"></cs-pagination>`,
          );
        ...
        it('should still render previous/next nav buttons in the compact format', async () => {
          ...
          const el = await fixture<CsPagination>(
            html`<cs-pagination total="237" page-size="10" page="3" format="compact" with-edges></cs-pagination>`,
          );
        ...
        it('should navigate via next/previous in the compact format', async () => {
          const el = await fixture<CsPagination>(
            html`<cs-pagination total="237" page-size="10" page="3" format="compact"></cs-pagination>`,
          );
          getButtonByPart(el, 'next-button')!.click();
          await el.updateComplete;
        ...
        it('should reflect format to an attribute', async () => {
          const el = await fixture<CsPagination>(
            html`<cs-pagination total="50" page-size="10" format="compact"></cs-pagination>`,
          );
        ...
        it('should combine the compact format with the summary', async () => {
          const el = await fixture<CsPagination>(
            html`<cs-pagination total="237" page-size="10" page="1" format="compact" with-summary></cs-pagination>`,
          );
        ...
        it('should render nothing in the compact format with hide-single-page and one page', async () => {
          const el = await fixture<CsPagination>(
            html`<cs-pagination total="5" page-size="10" format="compact" hide-single-page></cs-pagination>`,
          );
          expect(el.shadowRoot!.querySelector('nav')).to.not.exist;
        });
      });
      ...
      describe('sibling-count & boundary-count', () => {
        it('should default sibling-count to 2', async () => {
          const el = await fixture<CsPagination>(html`<cs-pagination total="500" page-size="10"></cs-pagination>`);
        ...
        it('should widen the visible window with a larger sibling-count', async () => {
          const el = await fixture<CsPagination>(
            html`<cs-pagination total="500" page-size="10" page="25" sibling-count="3"></cs-pagination>`,
          );
          const labels = getPageButtons(el).map((b) => b.textContent.trim());
        ...
        it('should narrow the visible window with sibling-count="0"', async () => {
          const el = await fixture<CsPagination>(
            html`<cs-pagination total="500" page-size="10" page="25" sibling-count="0"></cs-pagination>`,
          );
          const labels = getPageButtons(el).map((b) => b.textContent.trim());
        ...
        it('should pin extra boundary pages with a larger boundary-count', async () => {
          ...
          const el = await fixture<CsPagination>(
            html`<cs-pagination total="500" page-size="10" page="25" boundary-count="2"></cs-pagination>`,
          );
          const labels = getPageButtons(el).map((b) => b.textContent.trim());
      ...
      describe('page range rendering', () => {
        ...
        it('should keep a constant item count for a variety of truncated configurations', async () => {
          ...
          const el = await fixture<CsPagination>(html`<cs-pagination total="200" page-size="10"></cs-pagination>`);
          const countItems = () => el.shadowRoot!.querySelectorAll('[part~="pages"] > li').length;
      ...
      describe('page-size changes', () => {
        it('should reclamp the current page when page-size grows', async () => {
          ...
          const el = await fixture<CsPagination>(
            html`<cs-pagination total="200" page-size="10" page="18"></cs-pagination>`,
          );
          el.pageSize = 50;
          await el.updateComplete;
      ...
      describe('link mode (href-template)', () => {
        it('should render anchors with interpolated hrefs', async () => {
          const el = await fixture<CsPagination>(
            html`<cs-pagination total="200" page-size="10" page="3" href-template="/p?page={page}"></cs-pagination>`,
          );
        ...
        it('should drop href on disabled boundary links', async () => {
          const el = await fixture<CsPagination>(
            html`<cs-pagination total="200" page-size="10" page="1" href-template="/p?page={page}"></cs-pagination>`,
          );
          const prev = getButtonByPart(el, 'previous-button')!;
      ...
      describe('summary', () => {
        it('should render a "start–end of total" summary', async () => {
          const el = await fixture<CsPagination>(
            html`<cs-pagination total="237" page-size="10" page="1" with-summary></cs-pagination>`,
          );
          const summary = el.shadowRoot!.querySelector('[part~="summary"]')!;
          expect(summary.textContent.replace(/\s+/g, ' ').trim()).to.equal('1–10 of 237');
        });
        ...
        it('should reflect the current page in the summary', async () => {
          const el = await fixture<CsPagination>(
            html`<cs-pagination total="237" page-size="10" page="3" with-summary></cs-pagination>`,
          );
          const summary = el.shadowRoot!.querySelector('[part~="summary"]')!;
        ...
        it('should update the summary range when page-size changes', async () => {
          const el = await fixture<CsPagination>(
            html`<cs-pagination total="237" page-size="10" page="2" with-summary></cs-pagination>`,
          );
          const summary = el.shadowRoot!.querySelector('[part~="summary"]')!;
