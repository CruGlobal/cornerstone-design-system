...
import type CsInput from './input.js';

describe('<cs-input>', () => {
  runFormControlBaseTests({ tagName: 'cs-input', formValue: { dirtyValue: 'dirtied' } });

  for (const fixture of fixtures) {
    describe(`with "${fixture.type}" rendering`, () => {
      describe('accessibility', () => {
        it('should pass accessibility tests', async () => {
          const el = await fixture<CsInput>(html`<cs-input label="Name"></cs-input>`);
      ...
      describe('properties', () => {
        it('should have correct default property values', async () => {
          const el = await fixture<CsInput>(html`<cs-input></cs-input>`);
        ...
        it('should reflect the title attribute to the internal input', async () => {
          const el = await fixture<CsInput>(html`<cs-input title="Test"></cs-input>`);
          const input = el.shadowRoot!.querySelector<HTMLInputElement>('input')!;
          expect(input.title).to.equal('Test');
        });

        it('should be disabled with the disabled attribute', async () => {
          const el = await fixture<CsInput>(html`<cs-input disabled></cs-input>`);
          const input = el.shadowRoot!.querySelector<HTMLInputElement>('input')!;
          expect(input.disabled).to.equal(true);
        });

        it('should reflect the readonly attribute to the internal input', async () => {
          const el = await fixture<CsInput>(html`<cs-input readonly></cs-input>`);
          const input = el.shadowRoot!.querySelector<HTMLInputElement>('input')!;
          expect(input.readOnly).to.equal(true);
        });

        it('should reflect the placeholder attribute', async () => {
          const el = await fixture<CsInput>(html`<cs-input placeholder="Enter text"></cs-input>`);
          const input = el.shadowRoot!.querySelector<HTMLInputElement>('input')!;
      ...
      describe('slots', () => {
        it('should show "has-label" class when label slot is populated', async () => {
          const el = await fixture<CsInput>(html`<cs-input><span slot="label">Name</span></cs-input>`);
          const label = el.shadowRoot!.querySelector('[part~="form-control-label"]')!;
        ...
        it('should render the hint slot', async () => {
          const el = await fixture<CsInput>(html`<cs-input hint="Some hint"></cs-input>`);
      ...
      describe('events', () => {
        ...
        it('should not emit change or input when calling setRangeText()', async () => {
          const el = await fixture<CsInput>(html`<cs-input value="hi there"></cs-input>`);
        ...
        it('should emit cs-clear when the clear button is clicked', async () => {
          const el = await fixture<CsInput>(html`<cs-input with-clear value="hello"></cs-input>`);
          await el.updateComplete;

          const clearButton = el.shadowRoot!.querySelector<HTMLButtonElement>('[part~="clear-button"]')!;

          await expectEvent(el, 'cs-clear', () => clearButton.click());
      ...
      describe('clearable', () => {
        it('should show the clear button when with-clear is set and input has a value', async () => {
          const el = await fixture<CsInput>(html`<cs-input with-clear value="test"></cs-input>`);
          await el.updateComplete;
        ...
        it('should not show the clear button when the input is empty', async () => {
          const el = await fixture<CsInput>(html`<cs-input with-clear></cs-input>`);
          await el.updateComplete;
          const clearButton = el.shadowRoot!.querySelector('[part~="clear-button"]');
        ...
        it('should not show the clear button when disabled', async () => {
          const el = await fixture<CsInput>(html`<cs-input with-clear value="test" disabled></cs-input>`);
          await el.updateComplete;
          const clearButton = el.shadowRoot!.querySelector('[part~="clear-button"]');
          expect(clearButton).to.be.null;
        });
        ...
        it('should not show the clear button when readonly', async () => {
          const el = await fixture<CsInput>(html`<cs-input with-clear value="test" readonly></cs-input>`);
          await el.updateComplete;
          const clearButton = el.shadowRoot!.querySelector('[part~="clear-button"]');
          expect(clearButton).to.be.null;
        });

        it('should clear the value and emit input and change after cs-clear', async () => {
          const el = await fixture<CsInput>(html`<cs-input with-clear value="hello"></cs-input>`);
          await el.updateComplete;
      ...
      describe('password-toggle', () => {
        it('should show the password toggle button when type is password and password-toggle is set', async () => {
          const el = await fixture<CsInput>(html`<cs-input type="password" password-toggle></cs-input>`);
          await el.updateComplete;
        ...
        it('should not show the password toggle button when disabled', async () => {
          const el = await fixture<CsInput>(html`<cs-input type="password" password-toggle disabled></cs-input>`);
          await el.updateComplete;
          const toggleButton = el.shadowRoot!.querySelector('[part~="password-toggle-button"]');
      ...
      describe('keyboard navigation', () => {
        it('should submit the form when pressing enter in a form without a submit button', async () => {
          const form = await fixture<HTMLFormElement>(html`<form><cs-input></cs-input></form>`);
      ...
      describe('form integration', () => {
        it('should serialize its name and value with FormData', async () => {
          const form = await fixture<HTMLFormElement>(html`<form><cs-input name="a" value="1"></cs-input></form>`);
          const formData = new FormData(form);
          expect(formData.get('a')).to.equal('1');
        });

        it('should store on formData as an empty string', async () => {
          const form = await fixture<HTMLFormElement>(html`<form><cs-input name="a"></cs-input></form>`);
          const formData = new FormData(form);
        ...
        it('should not add a value to the form if disabled', async () => {
          const form = await fixture<HTMLFormElement>(
            html`<form><cs-input name="name" disabled required></cs-input></form>`,
          );
          const el = form.querySelector('cs-input')!;
          el.value = 'blah';
          await el.updateComplete;
        ...
        it('should be present in form data when using the form attribute and located outside of a <form>', async () => {
          const el = await fixture<HTMLFormElement>(html`
            <div>
              ...
              <cs-input form="f" name="a" value="1"></cs-input>
            </div>
          `);
        ...
        it('should submit with the correct form when the form attribute changes', async () => {
          const el = await fixture<HTMLFormElement>(html`
            <div>
              ...
              <cs-input form="f1" name="a" value="1"></cs-input>
            </div>
          `);
        ...
        it('should reset the element to its initial value', async () => {
          const form = await fixture<HTMLFormElement>(html`
            <form>
              <cs-input name="a" value="test"></cs-input>
        ...
        it('should be invalid when the input is empty and form.reportValidity() is called', async () => {
          const form = await fixture<HTMLFormElement>(html`
            <form>
              <cs-input required value=""></cs-input>
              <cs-button type="submit">Submit</cs-button>
            </form>
          `);
      ...
      describe('constraint validation', () => {
        ...
        it('should be invalid when required and empty', async () => {
          const el = await fixture<CsInput>(html`<cs-input required></cs-input>`);
          expect(el.reportValidity()).to.be.false;
          expect(el.checkValidity()).to.be.false;
        });

        it('should be invalid when required and disabled is removed', async () => {
          const el = await fixture<CsInput>(html`<cs-input disabled required></cs-input>`);
          expect(el.checkValidity()).to.be.true;
          el.disabled = false;
          await el.updateComplete;
          expect(el.checkValidity()).to.be.false;
        ...
        it('should validate against the pattern attribute', async () => {
          const el = await fixture<CsInput>(html`<cs-input required pattern="1234"></cs-input>`);
        ...
        it('should be invalid when minlength is not met', async () => {
          const el = await fixture<CsInput>(html`<cs-input required minlength="3"></cs-input>`);
        ...
        it('should be invalid when maxlength is exceeded via user interaction', async () => {
          const el = await fixture<CsInput>(html`<cs-input required maxlength="3" value="Hello World"></cs-input>`);
      ...
      describe('CSS parts and states', () => {
        it('should receive the correct validation states when valid', async () => {
          const el = await fixture<CsInput>(html`<cs-input required value="a"></cs-input>`);
        ...
        it('should receive validation states even when novalidate is used on the parent form', async () => {
          const el = await fixture<HTMLFormElement>(html`<form novalidate><cs-input required></cs-input></form>`);
          const input = el.querySelector<CsInput>('cs-input')!;
        ...
        it('should not have the blank state when the input has a value', async () => {
          const el = await fixture<CsInput>(html`<cs-input value="hello"></cs-input>`);
          await el.updateComplete;
      ...
      describe('when type="number"', () => {
        it('should be valid when the value is within the boundary of a step', async () => {
          const el = await fixture<CsInput>(html`<cs-input type="number" step=".5" value="1.5"></cs-input>`);
          expect(el.checkValidity()).to.be.true;
        });

        it('should be invalid when the value is not within the boundary of a step', async () => {
          const el = await fixture<CsInput>(html`<cs-input type="number" step=".5" value="1.25"></cs-input>`);
        ...
        it('should increment by step when stepUp() is called', async () => {
          const el = await fixture<CsInput>(html`<cs-input type="number" step="2" value="2"></cs-input>`);
        ...
        it('should return an empty string when the value is set to an invalid number', async () => {
          const el = await fixture<CsInput>(html`<cs-input type="number"></cs-input>`);
        ...
        it('should return an empty string when an invalid value is provided via the value attribute', async () => {
          const el = await fixture<CsInput>(html`<cs-input type="number" value="not-a-valid-number"></cs-input>`);
          await el.updateComplete;
      ...
      describe('when type="date"', () => {
        it('should return an empty string when the value is set to an invalid date', async () => {
          const el = await fixture<CsInput>(html`<cs-input type="date"></cs-input>`);
      ...
      describe('when type="time"', () => {
        it('should return an empty string when the value is set to an invalid time', async () => {
          const el = await fixture<CsInput>(html`<cs-input type="time"></cs-input>`);
      ...
      describe('when type="datetime-local"', () => {
        it('should return an empty string when the value is set to an invalid datetime', async () => {
          const el = await fixture<CsInput>(html`<cs-input type="datetime-local"></cs-input>`);
      ...
      describe('when using spellcheck', () => {
        ...
        it('should enable spellcheck when set to "true"', async () => {
          const el = await fixture<CsInput>(html`<cs-input spellcheck="true"></cs-input>`);
          const input = el.shadowRoot!.querySelector<HTMLInputElement>('input')!;
          expect(input.getAttribute('spellcheck')).to.equal('true');
          expect(input.spellcheck).to.be.true;
        });
        ...
        it('should disable spellcheck when set to "false"', async () => {
          const el = await fixture<CsInput>(html`<cs-input spellcheck="false"></cs-input>`);
          const input = el.shadowRoot!.querySelector<HTMLInputElement>('input')!;
      ...
      describe('methods', () => {
        it('should set replacement text in the correct location with setRangeText()', async () => {
          const el = await fixture<CsInput>(html`<cs-input value="test"></cs-input>`);
