...
import type CsScroller from './scroller.js';

describe('<cs-scroller>', () => {
  for (const fixture of fixtures) {
    describe(`with "${fixture.type}" rendering`, () => {
      describe('accessibility', () => {
        it('should pass accessibility tests', async () => {
          const el = await fixture<CsScroller>(html`<cs-scroller><div>Scrollable content</div></cs-scroller>`);
      ...
      describe('accessibility', () => {
        it('should render a component', async () => {
          const el = await fixture<CsScroller>(html` <cs-scroller></cs-scroller> `);
      ...
      describe('properties', () => {
        describe('orientation', () => {
          ...
          it('should reflect the orientation attribute', async () => {
            const el = await fixture<CsScroller>(html` <cs-scroller orientation="vertical"></cs-scroller> `);
        ...
        describe('without-scrollbar', () => {
          ...
          it('should reflect the without-scrollbar attribute', async () => {
            const el = await fixture<CsScroller>(html` <cs-scroller without-scrollbar></cs-scroller> `);
        ...
        describe('without-shadow', () => {
          ...
          it('should reflect the without-shadow attribute', async () => {
            const el = await fixture<CsScroller>(html` <cs-scroller without-shadow></cs-scroller> `);
      ...
      describe('slots', () => {
        it('should render slotted content', async () => {
          const el = await fixture<CsScroller>(html`
            <cs-scroller>
              <div>Content</div>
            </cs-scroller>
          `);
