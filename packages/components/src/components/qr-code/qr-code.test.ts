...
import type CsQrCode from './qr-code.js';

const getCanvas = (el: CsQrCode): HTMLCanvasElement => {
    ...
    describe(`with "${fixture.type}" rendering`, () => {
      describe('accessibility', () => {
        it('should be accessible', async () => {
          const el = await fixture<CsQrCode>(html`<cs-qr-code value="test data"></cs-qr-code>`);
        ...
        it('should use the label attribute as the aria-label when provided', async () => {
          const el = await fixture<CsQrCode>(html`<cs-qr-code value="test data" label="Scan me"></cs-qr-code>`);
          const canvas = getCanvas(el);
      ...
      describe('properties', () => {
        it('should have correct default property values', async () => {
          const el = await fixture<CsQrCode>(html`<cs-qr-code></cs-qr-code>`);
        ...
        it('should render a canvas element', async () => {
          const el = await fixture<CsQrCode>(html`<cs-qr-code value="hello"></cs-qr-code>`);
          const canvas = getCanvas(el);
          expect(canvas).to.be.instanceOf(HTMLCanvasElement);
        });

        it('should reflect the size as the rendered dimensions', async () => {
          const el = await fixture<CsQrCode>(html`<cs-qr-code value="test data" size="100"></cs-qr-code>`);
        ...
        it('should accept different error-correction levels', async () => {
          const el = await fixture<CsQrCode>(html`<cs-qr-code value="test" error-correction="L"></cs-qr-code>`);
          expect(el.errorCorrection).to.equal('L');
        });

        it('should accept a radius value', async () => {
          const el = await fixture<CsQrCode>(html`<cs-qr-code value="test" radius="0.5"></cs-qr-code>`);
          expect(el.radius).to.equal(0.5);
        });
      });

      describe('CSS parts and states', () => {
        it('should expose the qr-code CSS part on the canvas', async () => {
          const el = await fixture<CsQrCode>(html`<cs-qr-code value="test"></cs-qr-code>`);
          const canvas = getCanvas(el);
          expect(canvas.part.contains('qr-code')).to.be.true;
        });
      });

      describe('image', () => {
        it('should accept an image attribute', async () => {
          const el = await fixture<CsQrCode>(
            html`<cs-qr-code value="test" image="https://example.com/logo.png"></cs-qr-code>`,
          );
        ...
        it('should accept image-coverage attribute', async () => {
          const el = await fixture<CsQrCode>(
            html`<cs-qr-code value="test" image="https://example.com/logo.png" image-coverage="0.3"></cs-qr-code>`,
          );
        ...
        it('should accept image-padding attribute', async () => {
          const el = await fixture<CsQrCode>(
            html`<cs-qr-code value="test" image="https://example.com/logo.png" image-padding="5"></cs-qr-code>`,
          );
        ...
        it('should accept image-background attribute', async () => {
          const el = await fixture<CsQrCode>(
            html`<cs-qr-code value="test" image="https://example.com/logo.png" image-background="#fff"></cs-qr-code>`,
          );
