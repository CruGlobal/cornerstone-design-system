...
import type CsDivider from './divider.js';
    ...
    describe(`with "${fixture.type}" rendering`, () => {
      describe('accessibility', () => {
        it('should pass accessibility tests', async () => {
          const el = await fixture<CsDivider>(html`<cs-divider></cs-divider>`);
      ...
      describe('properties', () => {
        ...
        it('should reflect orientation to an attribute', async () => {
          const el = await fixture<CsDivider>(html`<cs-divider orientation="vertical"></cs-divider>`);
