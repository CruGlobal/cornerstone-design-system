...
import type CsComparison from './comparison.js';

describe('<cs-comparison>', () => {
  for (const fixture of fixtures) {
    describe(`with "${fixture.type}" rendering`, () => {
      describe('accessibility', () => {
        it('should pass accessibility tests', async () => {
          const el = await fixture<CsComparison>(
            html`<cs-comparison
              ><div slot="before">Before</div>
              <div slot="after">After</div></cs-comparison
            >`,
          );
      ...
      describe('accessibility', () => {
        it('should have a handle with role="scrollbar"', async () => {
          const el = await fixture<CsComparison>(html`
            <cs-comparison>
              <div slot="before"></div>
              <div slot="after"></div>
            </cs-comparison>
      ...
      describe('CSS parts and states', () => {
        it('should expose the expected CSS parts', async () => {
          ...
          expect(el.shadowRoot!.querySelector('[part~="comparison"]')).to.exist;
