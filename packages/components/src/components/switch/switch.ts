...
export default class CsSwitch extends CornerstoneFormAssociatedElement {
  ...
  setValue(value: string | File | FormData | null, stateValue?: string | File | FormData | null): void {
    if (!this.checked) {
