...
import type CsBreadcrumbItem from './breadcrumb-item.js';

describe('<cs-breadcrumb-item>', () => {
  for (const fixture of fixtures) {
    describe(`with "${fixture.type}" rendering`, () => {
      describe('accessibility', () => {
        it('should pass accessibility tests', async () => {
          const el = await fixture<CsBreadcrumbItem>(html`<cs-breadcrumb-item>Home</cs-breadcrumb-item>`);
        ...
        it('should pass accessibility tests with href', async () => {
          const el = await fixture<CsBreadcrumbItem>(html`
            <cs-breadcrumb-item href="https://example.com/">Home</cs-breadcrumb-item>
          `);
          if (fixture.type === 'client-only') {
            await expect(el).to.be.accessible();
          }
        ...
        it('should pass accessibility tests with href and target', async () => {
          const el = await fixture<CsBreadcrumbItem>(html`
            <cs-breadcrumb-item href="https://example.com/" target="_blank">Home</cs-breadcrumb-item>
          `);
          await expect(el).to.be.accessible();
        });

        it('should pass accessibility tests with an empty href', async () => {
          const el = await fixture<CsBreadcrumbItem>(
            html`<cs-breadcrumb-item href="">Current page</cs-breadcrumb-item>`,
          );
          await expect(el).to.be.accessible();
        });
      ...
      describe('properties', () => {
        ...
        it('should use a custom rel value when provided', async () => {
          const el = await fixture<CsBreadcrumbItem>(html`
            <cs-breadcrumb-item href="https://example.com/" target="_blank" rel="alternate">Home</cs-breadcrumb-item>
          `);
          const link = el.shadowRoot!.querySelector<HTMLAnchorElement>('[part~="label"]');
