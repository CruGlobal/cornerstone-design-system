  ...
  integrations: [
    ...
    starlight({
      ...
      head: [
        ...
        {
          tag: 'script',
          content: "document.documentElement.classList.add('cs-cloak');",
        },
        /**
        ...
        // reference theme is gone with the reason for it.
        {
          ...
          attrs: {
            rel: 'stylesheet',
            href: asset('/dist/styles/cornerstone.css'),
          },
        },
        {
          tag: 'script',
          attrs: { type: 'module', src: asset('/dist/cornerstone.loader.js') },
        },
        ...
        {
          tag: 'script',
          attrs: { type: 'module', src: asset('/scripts/code-examples.js') },
        },
        // Site search. Talks to Pagefind's JS API, so none of its widget CSS reaches the page.
        {
          tag: 'script',
          attrs: { type: 'module', src: asset('/scripts/site-search.js') },
        },
        ...
        // any page without a grid, which is every page but one.
        {
          ...
          attrs: {
            type: 'module',
            src: asset('/scripts/component-browser.js'),
          },
        },
        ...
        {
          tag: 'script',
          attrs: { type: 'module', src: asset('/scripts/nav-scroll.js') },
        },
      ],
